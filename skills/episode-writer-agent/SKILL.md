...
- lessons `## Shared` + `## episode-writer`（§14）；`*.review.md` 点评分发按 §22。
...
Sections: §0 §0a §2 §3 §4 §5 §7 §9 §10 §11 §12 §14 §15 §17 §18 §19 §21a-episode §21a-fail §22
...
① `Design:` 指向节拍单的 `#ep-NNN` 节——指针断（行缺/文件缺/节缺）⇒ block：`blocked` +
...
（characters voice/弧光、world 战力与数字锚点、north-star 红线）。⑤ 本项目 genre profile
...
③ 账本 delta 声明（§15.2）：逐条附正文行号，「无变化」也显式声明。④ 转 In Review：
