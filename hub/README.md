...
The project workbench has dedicated overview, source, story, character, art and quality
surfaces. Source pages expose fingerprints/checkpoints but never raw novel content. Story,
cast and art pages share `story/outline.v1.json`; cast and scene registries are derived rather
than regenerated by another model call. Quality states keep skipped/not-applicable separate
